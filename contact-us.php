...
<body>
    ...
    <main>
                            ...
                            <div class="col-lg-6 col-12">
                                <h4>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                        <g clip-path="url(#clip0_372_522)">
                                          <path d="M10.4637 21.713C10.5832 21.8923 10.7845 22 11 22C11.2155 22 11.4168 21.8923 11.5363 21.713C13.0616 19.425 15.3083 16.5993 16.874 13.7256C18.1258 11.4278 18.7344 9.46799 18.7344 7.73438C18.7344 3.46964 15.2647 0 11 0C6.73527 0 3.26562 3.46964 3.26562 7.73438C3.26562 9.46799 3.87419 11.4278 5.12604 13.7256C6.69049 16.5972 8.9415 19.4297 10.4637 21.713ZM11 1.28906C14.5539 1.28906 17.4453 4.18043 17.4453 7.73438C17.4453 9.24705 16.8881 11.0051 15.742 13.1089C14.3925 15.586 12.4667 18.0987 11 20.2112C9.53352 18.099 7.60762 15.5861 6.25801 13.1089C5.11186 11.0051 4.55469 9.24705 4.55469 7.73438C4.55469 4.18043 7.44605 1.28906 11 1.28906Z" fill="#1E1E1E"/>
                                          <path d="M11 11.6016C13.1324 11.6016 14.8672 9.86674 14.8672 7.73438C14.8672 5.60201 13.1324 3.86719 11 3.86719C8.86763 3.86719 7.13281 5.60201 7.13281 7.73438C7.13281 9.86674 8.86763 11.6016 11 11.6016ZM11 5.15625C12.4216 5.15625 13.5781 6.3128 13.5781 7.73438C13.5781 9.15595 12.4216 10.3125 11 10.3125C9.57842 10.3125 8.42188 9.15595 8.42188 7.73438C8.42188 6.3128 9.57842 5.15625 11 5.15625Z" fill="#1E1E1E"/>
                                        </g>
                                        <defs>
                                          <clipPath id="clip0_372_522">
                                ...
                                <h4>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" viewBox="0 0 20 16" fill="none">
                                        <g clip-path="url(#clip0_379_186)">
                                          <path d="M18.2422 0.837753H1.75781C0.786602 0.837753 0 1.62124 0 2.57781V13.0182C0 13.9804 0.792383 14.7582 1.75781 14.7582H18.2422C19.2053 14.7582 20 13.9837 20 13.0182V2.57781C20 1.62294 19.2165 0.837753 18.2422 0.837753ZM17.996 1.99779C17.6369 2.35141 11.4564 8.43728 11.243 8.6474C10.9109 8.97608 10.4695 9.15704 10 9.15704C9.53047 9.15704 9.08906 8.97604 8.75594 8.64632C8.61242 8.50499 2.50012 2.48632 2.00398 1.99779H17.996ZM1.17188 12.782V2.81465L6.23586 7.80107L1.17188 12.782ZM2.00473 13.5982L7.06672 8.61917L7.9284 9.46766C8.48176 10.0154 9.21746 10.3171 10 10.3171C10.7825 10.3171 11.5182 10.0154 12.0705 9.46875L12.9333 8.61917L17.9953 13.5982H2.00473ZM18.8281 12.782L13.7641 7.80107L18.8281 2.81465V12.782Z" fill="#252525"/>
                                        </g>
                                        <defs>
                                          <clipPath id="clip0_379_186">
                                            <rect width="20" height="14.5455" fill="white" transform="translate(0 0.727295)"/>
                                          </clipPath>
                                        </defs>
                                    </svg>
                                    E-mail Address
                                </h4>
                                <h6>coo@navimperialhospital.com</h6>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                ...
                                <h6>Our support team is available around the clock to address any concerns or queries you may have.</h6>
                            </div>
                            <div class="col-lg-6 col-12">
                                <h4>Feedback and Suggestions</h4>
                                <h6>We value your feedback and are continuously working to improve Snappy. Your input is crucial in shaping the future of Snappy.</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12 my-lg-0 my-2">
        ...
        <section class="map-bg">
            <div class="container">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3556.6946544072503!2d75.79441927489617!3d26.94489295870784!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396db3dd1c4a6e0b%3A0x776b8a0fc4c2bbd9!2sNav%20Imperial%20Hospital%20and%20Research%20Centre%20%7C%20RGHS%2C%20CGHS%20Hospital%20in%20Jaipur!5e0!3m2!1sen!2sin!4v1719986150001!5m2!1sen!2sin" width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </section>
    </main>
