    ...
    <main>
        ...
        <section class="home-banner">
            <img src="Images/banner.png" width="100%" height="auto"
                class="d-none d-sm-none d-md-none d-lg-block d-xl-block" alt="">
            <img src="Images/banner-phone.png" width="100%" height="auto"
                class="d-block d-sm-block d-md-block d-lg-none d-xl-none" alt="">
        </section>
        <!-- home-banner-end -->
        ...
        <section class="home-treatment">
            <div class="container">
                ...
                <div class="row head-box">
                    <div class="col-lg-4">
                        <img src="Images/ligament.png" class="img-fluid" alt="">
                    </div>
                    <div class="col-lg-4">
                        <img src="Images/spine.png" class="img-fluid" alt="">
                    </div>
                    <div class="col-lg-4">
                        <img src="Images/trauma.png" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <div class="content-box">
                            ...
                            <h6>Trauma is the state where human experiences intense & deep injuries due to some accident
                                or mishappening, Trauma can cause both physical and mental harm depending on the
                    ...
                    <div class="col-lg-7 col-12 d-flex justify-content-center flex-column">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                ...
                                <li>Advance technologies & equipments.</li>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 col-12">
                        <img src="Images/home-quality.png" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-4 col-12">
                        <div class="doctor-box">
                            <div class="box">
                                <img src="Images/doc-sachin.png" class="img-fluid" alt="">
                        ...
                        <div id="news-sliderr" class="owl-carousel">
                            <div class="post-slide">
                                <div class="d-flex gap-2 align-items-center justify-content-center flex-column">
                                    ...
                                    <p>Here are the 13 best supplements to reduce joint pain. These supplements include
                                        vitamins that help to get relief from Joint pain.</p>
